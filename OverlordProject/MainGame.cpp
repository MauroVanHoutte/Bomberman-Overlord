...
#endif
#ifdef BombermanGame
	SceneManager::GetInstance()->AddGameScene(new BombermanPauseScene());
	SceneManager::GetInstance()->AddGameScene(new BombermanScene());
	SceneManager::GetInstance()->AddGameScene(new BombermanGameOverScene());
	SceneManager::GetInstance()->AddGameScene(new BombermanStartMenu());
